...
function Sidebar() {
  return (
    <div className="  w-full  relative top-0 p-6  text-white h-[100vh] bg-[#73ccbf] shadow-lg w-6/6 rounded-bl-3xl">
      ...
      <div className=" w-full absolute left-2/4 top-2/4  font-bold translate-x-2/4 translate-y-2/4  items-end text-center page--details lg:flex flex-row-reverse justify-flex-start gap-[97px] lg:w-[95%] xl:block">
        <StaticImage
          ...
          alt="profileimage"
          className=" rounded-lg w-[150px] h-[150px]  md:w-[200px] md:h-[200px]  xl:w-[400px] xl:h-[400px]"
        />
        <div className="lg:text-left ">
          <p className=" mt-6 text-l text-bold md:text-l md:mt-0">
            Hi!, my name Is
          </p>
